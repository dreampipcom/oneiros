...
import * as CalendarView from "./03-CalendarView.stories.tsx";

<Meta of={CalendarView} title="CalendarView" />

# CalendarView

CalendarView component with different props.

#### Example

<Canvas of={CalendarView.Default} />
