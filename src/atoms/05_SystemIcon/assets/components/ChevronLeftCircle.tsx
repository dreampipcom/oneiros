...
// @icons/SystemIcon/chevron-left-circle
...
type TComponent = React.FC<
  ChevronLeftCircleProps & React.SVGProps<SVGSVGElement>
>;

const ChevronLeftCircle: TComponent = function ({
  color = 'black',
  width = 24,
  height = 24,
  ...props
