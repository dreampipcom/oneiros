...
type TComponent = React.FC<MinusCircleProps & React.SVGProps<SVGSVGElement>>;

const MinusCircle: TComponent = function ({
  color = 'black',
  width = 24,
  height = 24,
  ...props
