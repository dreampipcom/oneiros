...
// @icons/SystemIcon/box-light-vertical-horizontal-stipple
import React from 'react';

interface BoxLightVerticalHorizontalStippleProps {
  color?: string;
  width?: number | string;
...
type TComponent = React.FC<
  BoxLightVerticalHorizontalStippleProps & React.SVGProps<SVGSVGElement>
>;

const BoxLightVerticalHorizontalStipple: TComponent = function ({
  color = 'black',
  width = 24,
  height = 24,
  ...props
}: BoxLightVerticalHorizontalStippleProps) {
  return (
    <svg
    ...
    >
      <g fill={color}>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          id="memory-box-light-vertical-horizontal-stipple"
          viewBox="0 0 22 22"
        >
