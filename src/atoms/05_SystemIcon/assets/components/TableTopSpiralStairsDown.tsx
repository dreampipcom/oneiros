...
// @icons/SystemIcon/table-top-spiral-stairs-down
import React from 'react';

interface TableTopSpiralStairsDownProps {
  color?: string;
  width?: number | string;
...
type TComponent = React.FC<
  TableTopSpiralStairsDownProps & React.SVGProps<SVGSVGElement>
>;

const TableTopSpiralStairsDown: TComponent = function ({
  color = 'black',
  width = 24,
  height = 24,
  ...props
}: TableTopSpiralStairsDownProps) {
  return (
    <svg
