...
// @icons/SystemIcon/box-light-vertical-horizontal-stipple-right
import React from 'react';

interface BoxLightVerticalHorizontalStippleRightProps {
  color?: string;
  width?: number | string;
...
type TComponent = React.FC<
  BoxLightVerticalHorizontalStippleRightProps & React.SVGProps<SVGSVGElement>
>;

const BoxLightVerticalHorizontalStippleRight: TComponent = function ({
  color = 'black',
  width = 24,
  height = 24,
  ...props
}: BoxLightVerticalHorizontalStippleRightProps) {
  return (
    <svg
    ...
    >
      <g fill={color}>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          id="memory-box-light-vertical-horizontal-stipple-right"
          viewBox="0 0 22 22"
        >
