...
// @icons/SystemIcon/checker-small
import React from 'react';

interface CheckerSmallProps {
  color?: string;
  width?: number | string;
  height?: number | string;
}

type TComponent = React.FC<CheckerSmallProps & React.SVGProps<SVGSVGElement>>;

const CheckerSmall: TComponent = function ({
  color = 'black',
  width = 24,
  height = 24,
  ...props
