...
// @icons/SystemIcon/box-light-vertical-stipple-left
import React from 'react';

interface BoxLightVerticalStippleLeftProps {
  color?: string;
  width?: number | string;
...
type TComponent = React.FC<
  BoxLightVerticalStippleLeftProps & React.SVGProps<SVGSVGElement>
>;

const BoxLightVerticalStippleLeft: TComponent = function ({
  color = 'black',
  width = 24,
  height = 24,
  ...props
}: BoxLightVerticalStippleLeftProps) {
  return (
    <svg
    ...
    >
      <g fill={color}>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          id="memory-box-light-vertical-stipple-left"
          viewBox="0 0 22 22"
        >
