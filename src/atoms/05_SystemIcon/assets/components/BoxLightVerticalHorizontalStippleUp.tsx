...
// @icons/SystemIcon/box-light-vertical-horizontal-stipple-up
import React from 'react';

interface BoxLightVerticalHorizontalStippleUpProps {
  color?: string;
  width?: number | string;
...
type TComponent = React.FC<
  BoxLightVerticalHorizontalStippleUpProps & React.SVGProps<SVGSVGElement>
>;

const BoxLightVerticalHorizontalStippleUp: TComponent = function ({
  color = 'black',
  width = 24,
  height = 24,
  ...props
}: BoxLightVerticalHorizontalStippleUpProps) {
  return (
    <svg
    ...
    >
      <g fill={color}>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          id="memory-box-light-vertical-horizontal-stipple-up"
          viewBox="0 0 22 22"
        >
