...
// @icons/SystemIcon/box-light-horizontal-down-stipple
import React from 'react';

interface BoxLightHorizontalDownStippleProps {
  color?: string;
  width?: number | string;
...
type TComponent = React.FC<
  BoxLightHorizontalDownStippleProps & React.SVGProps<SVGSVGElement>
>;

const BoxLightHorizontalDownStipple: TComponent = function ({
  color = 'black',
  width = 24,
  height = 24,
  ...props
}: BoxLightHorizontalDownStippleProps) {
  return (
    <svg
    ...
    >
      <g fill={color}>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          id="memory-box-light-horizontal-down-stipple"
          viewBox="0 0 22 22"
        >
