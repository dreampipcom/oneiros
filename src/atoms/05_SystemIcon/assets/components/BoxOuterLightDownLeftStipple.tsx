...
// @icons/SystemIcon/box-outer-light-down-left-stipple
import React from 'react';

interface BoxOuterLightDownLeftStippleProps {
  color?: string;
  width?: number | string;
...
type TComponent = React.FC<
  BoxOuterLightDownLeftStippleProps & React.SVGProps<SVGSVGElement>
>;

const BoxOuterLightDownLeftStipple: TComponent = function ({
  color = 'black',
  width = 24,
  height = 24,
  ...props
}: BoxOuterLightDownLeftStippleProps) {
  return (
    <svg
    ...
    >
      <g fill={color}>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          id="memory-box-outer-light-down-left-stipple"
          viewBox="0 0 22 22"
        >
