...
// @icons/SystemIcon/arrow-left-circle
...
type TComponent = React.FC<
  ArrowLeftCircleProps & React.SVGProps<SVGSVGElement>
>;

const ArrowLeftCircle: TComponent = function ({
  color = 'black',
  width = 24,
  height = 24,
  ...props
