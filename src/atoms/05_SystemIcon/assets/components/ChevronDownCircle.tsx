...
// @icons/SystemIcon/chevron-down-circle
...
type TComponent = React.FC<
  ChevronDownCircleProps & React.SVGProps<SVGSVGElement>
>;

const ChevronDownCircle: TComponent = function ({
  color = 'black',
  width = 24,
  height = 24,
  ...props
