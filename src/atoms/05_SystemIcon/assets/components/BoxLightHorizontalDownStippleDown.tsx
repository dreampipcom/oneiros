...
// @icons/SystemIcon/box-light-horizontal-down-stipple-down
import React from 'react';

interface BoxLightHorizontalDownStippleDownProps {
  color?: string;
  width?: number | string;
...
type TComponent = React.FC<
  BoxLightHorizontalDownStippleDownProps & React.SVGProps<SVGSVGElement>
>;

const BoxLightHorizontalDownStippleDown: TComponent = function ({
  color = 'black',
  width = 24,
  height = 24,
  ...props
}: BoxLightHorizontalDownStippleDownProps) {
  return (
    <svg
    ...
    >
      <g fill={color}>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          id="memory-box-light-horizontal-down-stipple-down"
          viewBox="0 0 22 22"
        >
