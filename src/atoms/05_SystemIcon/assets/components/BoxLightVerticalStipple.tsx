...
// @icons/SystemIcon/box-light-vertical-stipple
import React from 'react';

interface BoxLightVerticalStippleProps {
  color?: string;
  width?: number | string;
...
type TComponent = React.FC<
  BoxLightVerticalStippleProps & React.SVGProps<SVGSVGElement>
>;

const BoxLightVerticalStipple: TComponent = function ({
  color = 'black',
  width = 24,
  height = 24,
  ...props
}: BoxLightVerticalStippleProps) {
  return (
    <svg
    ...
    >
      <g fill={color}>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          id="memory-box-light-vertical-stipple"
          viewBox="0 0 22 22"
        >
