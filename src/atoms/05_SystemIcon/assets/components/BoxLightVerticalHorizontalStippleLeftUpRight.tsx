...
// @icons/SystemIcon/box-light-vertical-horizontal-stipple-left-up-right
import React from 'react';

interface BoxLightVerticalHorizontalStippleLeftUpRightProps {
  color?: string;
  width?: number | string;
...
type TComponent = React.FC<
  BoxLightVerticalHorizontalStippleLeftUpRightProps &
    React.SVGProps<SVGSVGElement>
>;

const BoxLightVerticalHorizontalStippleLeftUpRight: TComponent = function ({
  color = 'black',
  width = 24,
  height = 24,
  ...props
  ...
  return (
    ...
    >
      <g fill={color}>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          id="memory-box-light-vertical-horizontal-stipple-left-up-right"
          viewBox="0 0 22 22"
        >
