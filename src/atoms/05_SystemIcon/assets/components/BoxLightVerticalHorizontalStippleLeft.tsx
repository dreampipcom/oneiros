...
// @icons/SystemIcon/box-light-vertical-horizontal-stipple-left
import React from 'react';

interface BoxLightVerticalHorizontalStippleLeftProps {
  color?: string;
  width?: number | string;
...
type TComponent = React.FC<
  BoxLightVerticalHorizontalStippleLeftProps & React.SVGProps<SVGSVGElement>
>;

const BoxLightVerticalHorizontalStippleLeft: TComponent = function ({
  color = 'black',
  width = 24,
  height = 24,
  ...props
}: BoxLightVerticalHorizontalStippleLeftProps) {
  return (
    <svg
    ...
    >
      <g fill={color}>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          id="memory-box-light-vertical-horizontal-stipple-left"
          viewBox="0 0 22 22"
        >
