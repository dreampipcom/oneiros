...
// @icons/SystemIcon/alpha-q
import React from 'react';

interface AlphaQProps {
  color?: string;
  width?: number | string;
  height?: number | string;
}

type TComponent = React.FC<AlphaQProps & React.SVGProps<SVGSVGElement>>;

const AlphaQ: TComponent = function ({
  color = 'black',
  width = 24,
  height = 24,
  ...props
