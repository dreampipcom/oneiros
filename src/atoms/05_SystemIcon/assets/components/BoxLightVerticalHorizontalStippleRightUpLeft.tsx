...
// @icons/SystemIcon/box-light-vertical-horizontal-stipple-right-up-left
import React from 'react';

interface BoxLightVerticalHorizontalStippleRightUpLeftProps {
  color?: string;
  width?: number | string;
...
type TComponent = React.FC<
  BoxLightVerticalHorizontalStippleRightUpLeftProps &
    React.SVGProps<SVGSVGElement>
>;

const BoxLightVerticalHorizontalStippleRightUpLeft: TComponent = function ({
  color = 'black',
  width = 24,
  height = 24,
  ...props
  ...
  return (
    ...
    >
      <g fill={color}>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          id="memory-box-light-vertical-horizontal-stipple-right-up-left"
          viewBox="0 0 22 22"
        >
