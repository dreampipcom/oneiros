...
// @icons/SystemIcon/box-light-round-down-right-stipple
import React from 'react';

interface BoxLightRoundDownRightStippleProps {
  color?: string;
  width?: number | string;
...
type TComponent = React.FC<
  BoxLightRoundDownRightStippleProps & React.SVGProps<SVGSVGElement>
>;

const BoxLightRoundDownRightStipple: TComponent = function ({
  color = 'black',
  width = 24,
  height = 24,
  ...props
}: BoxLightRoundDownRightStippleProps) {
  return (
    <svg
