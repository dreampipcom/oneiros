...
// @icons/SystemIcon/box-light-up-right-stipple
import React from 'react';

interface BoxLightUpRightStippleProps {
  color?: string;
  width?: number | string;
...
type TComponent = React.FC<
  BoxLightUpRightStippleProps & React.SVGProps<SVGSVGElement>
>;

const BoxLightUpRightStipple: TComponent = function ({
  color = 'black',
  width = 24,
  height = 24,
  ...props
}: BoxLightUpRightStippleProps) {
  return (
    <svg
    ...
    >
      <g fill={color}>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          id="memory-box-light-up-right-stipple"
          viewBox="0 0 22 22"
        >
